...
const purchaseInit = (state, action) =>{ return updateObject(state, {purchased: false})};

const purchaseStart = (state, action) =>{ return updateObject(state, {loading: true})};
...
const purchaseBurgerFailure = (state, action) => {return updateObject(state, {loading: false})};
...
const fetchOrdersFailure = (state, action) => { return updateObject(state, {loading: false})}
